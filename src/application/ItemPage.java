...
//				if(nv.getUserData().equals("addItem")) {
////					idTf.setEditable(false);
//					addItemBtn.setDisable(true);
//					
//				}else if(nv.getUserData().equals("updateItem")){
...
//			ItemBrand.setName(brandCombo.getValue());
		...
		// Update button
		Button updateItemBtn = new Button("Update");
		addItemBtnPane.add(updateItemBtn, 1, 0);
		updateItemBtn.setId("fg-updateItemBtn");
